...
@section('contenido')
    ...
    <div class="flex justify-center">
        <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col items-center md:flex-row">
            ...
            <div class="md:w-8/12 flex flex-col items-center md:items-start md:justify-center lg:w-6/12 px-5 py-10 md:py-10">
                ...
                <div class="flex items-center gap-2">
                    ...
                    @auth
                        @if ($user->id === auth()->user()->id)
                            ...
                            >
                                <svg class="w-5 h-5" data-slot="icon" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
